...
import com.nch.cryptrader.util.jwt.ExtraClaimKey;
import com.nch.cryptrader.util.jwt.TokenType;
...
public class JwtService {
    ...
    @Value("${cryp-trader.secret-key}")
    private CharSequence SECRET_KEY;

    @Value("${cryp-trader.refresh-token-expiration-minutes}")
    private Integer REFRESH_TOKEN_EXPIRATION_TIME_MIN;

    @Value("${cryp-trader.access-token-expiration-minutes}")
